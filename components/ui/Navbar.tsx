        ...
        <div className="max-w-lg mx-auto flex items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-1">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-sm text-amber-400/70 hover:text-amber-400 transition-colors"
            >
              ★ Rate
            </button>
            <button
        ...
        {menuOpen && (
          <div className="sm:hidden border-t border-white/10 mt-3 pt-3 flex flex-col gap-1 max-w-lg mx-auto">
            ...
            <button
              ...
              className="px-3 py-2.5 rounded-lg text-sm text-amber-400/70 text-left"
            >
              ★ Rate Book Jimmy&apos;s
            </button>
            <button
